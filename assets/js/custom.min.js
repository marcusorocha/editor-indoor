...
var e = function() 
{
    ...
    var t = $BODY.hasClass("footer_fixed") ? 0 : $FOOTER.height();
    var n = $LEFT_COL.eq(1).height() + $SIDEBAR_FOOTER.height();
    var i = n > e ? n : e;
    i -= $NAV_MENU.height() + t,
    $RIGHT_COL.css("min-height", i);
};

var fnToggleMenu = function(t)
{
    var n = $(t).parent();
    ...
    if (n.is(".active"))
    {
        ...
        n.addClass("active");
        $("ul:first",n).slideDown(function(){e()});
    }
};
...
$(document).ready(function()
{
    ...
    //$SIDEBAR_MENU.find("a").on("click", fnToggleMenu);
